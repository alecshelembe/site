...
if (isset($_GET['register'])) {
	$email = get_check("email");
	$email = sanitizeString($email);
	$name = get_check("name");
	$name = sanitizeString($name);
	$number = get_check("number");
	$number = sanitizeString($number);
	$password = get_check("password");
	$password = sanitizeString($password);
	$confirm_password = get_check("confirm_password");
	$confirm_password = sanitizeString($confirm_password);
	$gender = get_check("gender");
	$gender = sanitizeString($gender);
	$course = get_check("course");
	$course = sanitizeString($course);
	$address = get_check("address");
	$address = sanitizeString($address);
	$surname = get_check("surname");
	...
	update_info($conn,$dbname,'users','course','email',$course,$email);
